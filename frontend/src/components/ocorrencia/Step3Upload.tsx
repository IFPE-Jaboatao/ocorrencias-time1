...
export default function Step3Upload({ formData, atualizarDados, onNext, onBack }: StepProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h2 className="text-2xl font-bold text-gray-700 mb-1">Upload de anexos e comprovantes</h2>
        <p className="text-sm text-gray-500 mb-4">Adicionar justificativas (anexos, comprovantes, etc):</p>
      </div>

      <div className="flex w-full items-center justify-center">
        <Label htmlFor="dropzone-file" className="flex h-44 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100">

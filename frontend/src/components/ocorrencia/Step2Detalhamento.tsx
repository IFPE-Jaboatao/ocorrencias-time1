...
export default function Step2Detalhamento({ formData, atualizarDados, onNext, onBack }: StepProps) {
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h2 className="text-2xl font-bold text-gray-700 mb-1">Detalhamento da ocorrência</h2>
        <p className="text-sm text-gray-500 mb-4">Descreva a ocorrência em detalhes:</p>
      </div>
